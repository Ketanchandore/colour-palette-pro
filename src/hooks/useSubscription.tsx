...
export const SUBSCRIPTION_CONFIG = {
  free: {
    ...
    level: 4,
    rankLabel: 'Creator',
    features: ['Basic color tools', 'Limited usage (10/month)', 'Community support'],
  ...
  silver: {
    ...
    level: 3,
    rankLabel: 'Starter',
    features: ['Silver Theme', 'Core tools unlocked', 'Limited advanced features', '50 uses/month', 'Priority support'],
  ...
  gold: {
    ...
    level: 2,
    rankLabel: 'Pro',
    features: ['Gold Theme', 'Advanced AI tools', 'More features unlocked', '200 uses/month', 'Priority processing', 'Premium support'],
    advancedToolsAccess: true,
    discount: { quarterly: 10, biannual: 15, annual: 20 },
  },
  diamond: {
    ...
    level: 1,
    rankLabel: 'Elite',
    features: ['Diamond Theme', 'All features unlocked', 'Unlimited uses', 'Experimental AI', 'Early access', 'VIP priority support'],
    advancedToolsAccess: true,
    discount: { quarterly: 10, biannual: 15, annual: 20 },
  },
};
