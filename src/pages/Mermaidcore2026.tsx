    ...
    <MainLayout>
      ...
      <div className="space-y-0 -m-6 lg:-m-8">
        ...
        <InternalLinks links={[
          ...
          { label: "Thermal Glow 2026", path: "/trends/thermal-glow-2026", description: "Infrared heat color palette" },
          { label: "All 2026 Trends", path: "/trends", description: "Explore all trending palettes" },
          { label: "Palette Generator", path: "/generator", description: "Create ocean-inspired palettes" },
          { label: "Color Explorer", path: "/color-explorer", description: "Browse 50,000+ colors" },
          { label: "Color Blindness Simulator", path: "/blindness-simulator", description: "Test palette accessibility" },
        ]} />
      </div>
    </MainLayout>
  );
