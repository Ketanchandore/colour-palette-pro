  ...
  return (
    <MainLayout>
      ...
      <div className="space-y-6">
        ...
        <FAQSection faqs={[
          { question: "What is the AI Brand Architect?", answer: "It's a free AI tool that generates complete brand identities including color palettes, typography recommendations, and button styles based on your brand description and industry." },
          { question: "Can I use the generated brand identity commercially?", answer: "Yes! All brand identities generated by our AI are free to use in personal and commercial projects without attribution." },
          { question: "How accurate are the AI brand suggestions?", answer: "Our AI is trained on millions of successful brands and design systems. It considers color psychology, industry standards, and accessibility to generate professional-grade brand identities." },
        ]} />

        <InternalLinks links={[
          { label: "Brand Colors", path: "/brand-colors", description: "See HEX codes from 50+ famous brands" },
          { label: "URL Brand Extractor", path: "/url-extractor", description: "Extract colors from any website" },
          { label: "AI Color Suggestions", path: "/ai-suggestions", description: "AI-generated color palettes" },
          { label: "Social Media Kit", path: "/social-kit", description: "Create branded social graphics" },
          { label: "Code Export", path: "/code-export", description: "Export brand as CSS, Tailwind" },
          { label: "Live UI Preview", path: "/live-preview", description: "Preview brand on UI mockups" },
        ]} />
    </MainLayout>
  );
}
