...
import { HomepageSEO } from "@/components/dashboard/HomepageSEO";
...
const homepageLinks = [
  ...
  { label: "Wedding Color Palettes", path: "/palettes/wedding-color-palettes", description: "12+ trending wedding palettes for 2026" },
  { label: "Pastel Color Palettes", path: "/palettes/pastel-color-palettes", description: "Soft aesthetic palettes with HEX codes" },
  { label: "Dark Mode Palettes", path: "/palettes/dark-mode-color-palettes", description: "Professional dark UI themes (GitHub, Dracula, Nord)" },
  { label: "Minimalist Palettes", path: "/palettes/minimalist-color-palettes", description: "Scandinavian, Japanese & monochrome palettes" },
...
export default function Index() {
  ...
  const structuredData = {
    ...
    description: "AI-powered color palette generator with WCAG accessibility tools, brand analysis, 50,000+ colors, and 2026 trend palettes. Free for designers & developers.",
    applicationCategory: "DesignApplication",
    operatingSystem: "Web",
    offers: { "@type": "Offer", price: "0", priceCurrency: "USD" },
    creator: { "@type": "Organization", name: "Colour Pine", url: "https://colourpine.com" },
    featureList: [
      "AI Color Palette Generator",
      "WCAG Contrast Checker",
      "Color Blindness Simulator",
      "50,000+ Color Database",
      "Image Color Extractor",
      "AI Brand Architect",
      "Live UI Preview",
      "Code Export (CSS, Tailwind, SCSS, Swift, Flutter)",
      "2026 Color Trends",
      "Social Media Kit",
  ...
  return (
    <MainLayout>
      <SEOHead
        title="Colour Pine — #1 Free AI Color Palette Generator & WCAG Tools 2026"
        description="World's most advanced free color palette generator. AI-powered brand analysis, WCAG contrast checker, color blindness simulator, 50,000+ colors, 2026 trend palettes. Used by 100K+ designers & developers."
        keywords="color palette generator, free color palette generator, ai color palette, wcag contrast checker, brand colors, 2026 color trends, hex to rgb converter, tailwind color palette, color blindness simulator, accessibility color checker, color scheme generator, design system colors"
      ...
      <div className="p-6 lg:p-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <StatsCard title="Total Palettes" value="12,847" icon={<Palette className="w-6 h-6" />} gradient="purple" delay={0} />
          <StatsCard title="Generated Today" value="1,234" icon={<TrendingUp className="w-6 h-6" />} gradient="teal" delay={100} />
          <StatsCard title="Active Users" value="5,678" icon={<Users className="w-6 h-6" />} gradient="coral" delay={200} />
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-display font-bold text-foreground">Featured Palettes</h2>
              <p className="text-muted-foreground mt-1">Hand-picked color combinations for your inspiration</p>
            </div>
            <Link to="/trending">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link to="/generator" className="group relative overflow-hidden rounded-2xl p-8 bg-card border border-border hover:border-primary/30 transition-all duration-300 hover:shadow-glow-md">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-display font-bold text-foreground mb-2">Generate Palettes</h3>
              <p className="text-muted-foreground">Create unique color combinations with our smart palette generator</p>
            </div>
          </Link>
          <Link to="/collections" className="group relative overflow-hidden rounded-2xl p-8 bg-card border border-border hover:border-secondary/30 transition-all duration-300 hover:shadow-glow-md">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl font-display font-bold text-foreground mb-2">Explore Collections</h3>
              <p className="text-muted-foreground">Browse curated collections for every mood and style</p>
            </div>
          </Link>
        </div>
        ...
        {/* SEO Sections: How It Works, Use Cases, Testimonials, FAQ */}
        <HomepageSEO />
