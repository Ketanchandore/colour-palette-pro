  ...
  return (
    <MainLayout>
      ...
      <div className="p-6 lg:p-8 space-y-8">
        ...
        <FAQSection faqs={[
          { question: "How does AI color suggestion work?", answer: "Our AI analyzes your project description, industry, and mood to generate harmonious color palettes using advanced language models trained on millions of successful designs." },
          { question: "Are the AI-generated palettes free to use?", answer: "Yes! All palettes generated by our AI are completely free to use in personal and commercial projects. No attribution required." },
          { question: "Can I customize the AI suggestions?", answer: "Absolutely. Describe your project in detail — mention your industry, target audience, mood, and brand personality. The more context you provide, the better the AI palette matches your needs." },
        ]} />

        <InternalLinks links={[
          { label: "Palette Generator", path: "/generator", description: "Create palettes with complementary and triadic modes" },
          { label: "Brand Architect", path: "/brand-architect", description: "Generate complete brand identities with AI" },
          { label: "Mood AI Search", path: "/mood-search", description: "Find colors by emotion or feeling" },
          { label: "Image Extractor", path: "/image-extractor", description: "Extract colors from any photo" },
          { label: "Trending Palettes", path: "/trending", description: "See the most popular color combinations" },
          { label: "Color Theory Guide", path: "/glossary/color-theory", description: "Learn about color harmony fundamentals" },
        ]} />
      </div>
    </MainLayout>
  );
